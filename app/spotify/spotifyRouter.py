...
from app.helpers.spotify import search_artist_name, get_artist, get_artist_related, get_artist_track
...
def artist(id):
    ...
    tracks_data = get_artist_track(id)
    tracks = tracks_data['tracks']    
    
    relateds_data = get_artist_related(id)
